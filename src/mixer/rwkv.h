#ifndef RWKV_COMPRESS_H
#define RWKV_COMPRESS_H
...
class Rwkv: public NMixer {
 public:
  Rwkv(unsigned int input_size, unsigned int output_size, unsigned int
...
private:
 ...
 private:
  llvm::SmallVector<RwkvLayer, 1> layers_;
